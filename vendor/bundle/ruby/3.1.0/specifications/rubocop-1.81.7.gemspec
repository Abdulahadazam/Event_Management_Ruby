...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<lint_roller>.freeze, ["~> 1.1.0"])
    s.add_dependency(%q<parallel>.freeze, ["~> 1.10"])
    s.add_dependency(%q<parser>.freeze, [">= 3.3.0.2"])
    s.add_dependency(%q<rainbow>.freeze, [">= 2.2.2", "< 4.0"])
    s.add_dependency(%q<regexp_parser>.freeze, [">= 2.9.3", "< 3.0"])
    s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.47.1", "< 2.0"])
    s.add_dependency(%q<ruby-progressbar>.freeze, ["~> 1.7"])
    s.add_dependency(%q<unicode-display_width>.freeze, [">= 2.4.0", "< 4.0"])
  end
end
