# -*- encoding: utf-8 -*-
# stub: solargraph 0.57.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rbs>.freeze, [">= 3.6.1", "<= 4.0.0.dev.4"])
    ...
    s.add_runtime_dependency(%q<yard-activesupport-concern>.freeze, ["~> 0.0"])
    ...
    s.add_development_dependency(%q<rubocop-yard>.freeze, ["~> 1.0"])
    s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.21"])
    s.add_development_dependency(%q<simplecov-lcov>.freeze, ["~> 0.8"])
    s.add_development_dependency(%q<undercover>.freeze, ["~> 0.7"])
    s.add_development_dependency(%q<overcommit>.freeze, ["~> 0.68.0"])
    ...
    s.add_dependency(%q<benchmark>.freeze, ["~> 0.4"])
    s.add_dependency(%q<bundler>.freeze, ["~> 2.0"])
    s.add_dependency(%q<diff-lcs>.freeze, ["~> 1.4"])
    s.add_dependency(%q<jaro_winkler>.freeze, ["~> 1.6", ">= 1.6.1"])
    ...
    s.add_dependency(%q<observer>.freeze, ["~> 0.1"])
    s.add_dependency(%q<ostruct>.freeze, ["~> 0.6"])
    s.add_dependency(%q<parser>.freeze, ["~> 3.0"])
    s.add_dependency(%q<prism>.freeze, ["~> 1.4"])
    s.add_dependency(%q<rbs>.freeze, [">= 3.6.1", "<= 4.0.0.dev.4"])
    s.add_dependency(%q<reverse_markdown>.freeze, ["~> 3.0"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.76"])
    s.add_dependency(%q<thor>.freeze, ["~> 1.0"])
    s.add_dependency(%q<tilt>.freeze, ["~> 2.0"])
    s.add_dependency(%q<yard>.freeze, ["~> 0.9", ">= 0.9.24"])
    s.add_dependency(%q<yard-solargraph>.freeze, ["~> 0.1"])
    s.add_dependency(%q<yard-activesupport-concern>.freeze, ["~> 0.0"])
    s.add_dependency(%q<pry>.freeze, ["~> 0.15"])
    s.add_dependency(%q<public_suffix>.freeze, ["~> 3.1"])
    s.add_dependency(%q<rake>.freeze, ["~> 13.2"])
    s.add_dependency(%q<rspec>.freeze, ["~> 3.5"])
    s.add_dependency(%q<rubocop-rake>.freeze, ["~> 0.7"])
    s.add_dependency(%q<rubocop-rspec>.freeze, ["~> 3.6"])
    s.add_dependency(%q<rubocop-yard>.freeze, ["~> 1.0"])
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.21"])
    s.add_dependency(%q<simplecov-lcov>.freeze, ["~> 0.8"])
    s.add_dependency(%q<undercover>.freeze, ["~> 0.7"])
    s.add_dependency(%q<overcommit>.freeze, ["~> 0.68.0"])
    s.add_dependency(%q<webmock>.freeze, ["~> 3.6"])
    s.add_dependency(%q<irb>.freeze, ["~> 1.15"])
  end
end
