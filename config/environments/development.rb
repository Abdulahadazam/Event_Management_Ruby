...
Rails.application.configure do
  ...
  # Use letter_opener_web to preview emails in the browser with a web interface
  # Access all sent emails at http://localhost:3000/letter_opener
  config.action_mailer.delivery_method = :letter_opener_web
  config.action_mailer.perform_deliveries = true
  config.action_mailer.raise_delivery_errors = true

  # Uncomment the lines below if you want to use SMTP instead of letter_opener
